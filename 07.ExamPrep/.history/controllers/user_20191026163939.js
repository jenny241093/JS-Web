...
module.exports = {
    get: {
        ...
        getInfo: (req, res, next) => {
            res.render('account-info.hbs', { pageTitle: 'Account Info' });
        }
    },
    ...
    post: {
        ...
        register: (req, res, next) => {
            const { username, password, repeatPassword, total } = req.body;

            models.User.create({ username, password, total }).then((registeredUser) => {
